#!/usr/bin/env python3
"""Generate WIRE_PROTOCOL.md from pydantic models in repo_claude.core.bus."""
...
def generate() -> str:
    ...
    sections = [
        ...
        "## Transport\n\n",
        "- TCP loopback `127.0.0.1:7437` (override via `REPO_HOST` / `REPO_PORT`)\n",
        ...
        _model_section("LogLineEvent", LogLineEvent,
            {"type": "log.line", "run_id": run_id, "level": "INFO",
             "source": "repo_claude.core.loop", "message": "step 1 started", "ts": ts}),
        "\n## Session Events\n\n",
