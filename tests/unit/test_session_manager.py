...
from repo_claude.core.runner import RunOutcome
from repo_claude.core.session.manager import SESSION_CLOSED, SESSION_NOT_FOUND, SessionManager
...
# 设计：复用 mock runner 的成功路径，聚焦 mode 对最终状态的影响，保证.repo run 的统一路径正确
