...
from repo_claude.core.bus.events import RunFinishedEvent, RunStartedEvent
from repo_claude.core.compact.compactor import Compactor
from repo_claude.core.config import RepoConfig
from repo_claude.core.context import ExecutionContext
from repo_claude.core.events.bus import EventBus, EventHandler
from repo_claude.core.events.writer import EventWriter
from repo_claude.core.llm.base import LLMProvider
from repo_claude.core.llm.provider import AnthropicProvider
from repo_claude.core.loop import AgentLoop
from repo_claude.core.mcp.server import McpServerManager
from repo_claude.core.memory.loader import load_context_file
from repo_claude.core.permissions.manager import PermissionManager
from repo_claude.core.runs import RUNS_DIR, new_run_id
from repo_claude.core.session.model import Session
from repo_claude.core.session.store import SessionStore
from repo_claude.core.subagent.registry import BackgroundTaskRegistry
from repo_claude.core.subagent.tool import AgentResultTool, SpawnAgentTool
from repo_claude.core.task.manager import TaskManager
from repo_claude.core.tools.builtin import (
    BashTool,
    ListDirTool,
    NoteSaveTool,
    ReadFileTool,
...
from repo_claude.core.tools.registry import ToolRegistry
from repo_claude.core.trace.provider import TracingProvider
from repo_claude.core.trace.writer import TraceWriter
...
class AgentRunner:
    ...
    async def run_and_capture(
        ...
        *,
        ...
        global_ctx = load_context_file(Path("~/.repo/context.md").expanduser())
        project_ctx = load_context_file(Path(".repo/context.md"))
