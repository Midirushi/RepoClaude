...
from repo_claude.core.bus.envelope import HandlerError
from repo_claude.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from repo_claude.core.session.model import Session, SessionMode
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from repo_claude.core.bus.commands import SessionCompactResult
