...
from repo_claude.cli.commands.chat import cmd_chat
from repo_claude.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from repo_claude.cli.commands.ping import cmd_ping
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="repo", description="RepoClaude CLI")
